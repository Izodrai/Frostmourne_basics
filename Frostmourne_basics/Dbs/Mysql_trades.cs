...
namespace Frostmourne_basics.Dbs
{
    public partial class Mysql
    {
        public Error Get_trade_by_order_id(ref Trade _trade)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT id, symbol_id, trade_type_id, xtb_order_id_1, xtb_order_id_2, opened_at, closed_at, opened_value, closed_value, opened_reason, closed_reason, stop_loss_value, volume, profit FROM trades WHERE xtb_order_id_2 = @xtb_order_id_2 ", this.Mysql_connector);
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        _trade = new Trade(id, xtb_order_id_1, xtb_order_id_2, s, trade_type, volume, stop_loss, profit, opened_at, closed_at, opened_price, closed_price, opened_reason, closed_reason);
                    }
                }
        ...
        public Error New_trade(ref Trade _trade)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@profit", 1);
                ...
                cmd.Parameters["@profit"].Value = _trade.Profit;
